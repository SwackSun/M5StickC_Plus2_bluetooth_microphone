#ifndef _HF_SESSION_H
#define _HF_SESSION_H
...
private:
  ...
  void bt_hf_client_hdl_stack_evt(uint16_t event, void *p_param)
  {
      ...
      case BT_APP_EVT_STACK_UP: {
          ...
          esp_bt_gap_register_callback([](esp_bt_gap_cb_event_t event, esp_bt_gap_cb_param_t *param) { HFSession::ActiveSession->esp_bt_gap_cb(event, param); });
...
public:
  ...
  bool start(BluetoothAddress deviceAddress)
  {
    ...
    bt_app_work_dispatch([](uint16_t event, void *param) { HFSession::ActiveSession->bt_hf_client_hdl_stack_evt(event, param); }, BT_APP_EVT_STACK_UP, NULL, 0, NULL);
